...
export class RegisterPageComponent {
  ...
  public myForm: FormGroup = this.formBuilder.nonNullable.group(
    ...
    {
      /* al hacerlo de esta forma tenemos la opción de colocar otro objeto el cual puede tener validadores asíncronos, validadores síncronos y condiciones para actualizar pero este segundo objeto será utilizado más para los validadores asíncronos o validadores síncronos pero de forma grupal, es decir, a nivel de todo el formulario como tal */
      /* la ventaja de hacerlo así es que a las funciones que se le coloquen al array de validators se les va a pasar como argumento implícito todo el formulario con la finalidad de tener todo el formulario y sus campos, hacerlo como arriba es a nivel de control (por cada campo) y hacerlo aquí es a nivel de formulario en general */
      validators: [
        /* aquí solo se están mandando los nombre de los campos a evaluar, por eso esperaba field1 y field1 2 de tipo string */
